...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x20,0x64,0x65
	.DB  0x61,0x72,0x21,0x20,0x69,0x27,0x6D,0x20
	.DB  0x4D,0x48,0x54,0x72,0x58,0x7A,0x20,0x20
	.DB  0x20,0x0,0x68,0x61,0x68,0x61,0x68,0x61
	.DB  0x68,0x61,0x68,0x61,0x68,0x61,0x68,0x61
	.DB  0x68,0x61,0x68,0x61,0x68,0x61,0x68,0x61
	.DB  0x68,0x61,0x68,0x61,0x68,0x61,0x68,0x61
	.DB  0x68,0x61,0x68,0x61,0x68,0x61,0x68,0x61
	.DB  0x68,0x61,0x0,0x25,0x64,0x3A,0x25,0x64
	.DB  0x3A,0x25,0x64,0x20,0x20,0x20,0x25,0x34
...
; 0000 0097 // Characters/line: 40
; 0000 0098 lcd_init(40);
	LDI  R26,LOW(40)
	CALL _lcd_init
; 0000 0099 
; 0000 009A 
...
; 0000 009E lcd_clear();
	CALL _lcd_clear
; 0000 009F lcd_puts("Hello dear! i'm MHTrXz   ");
	__POINTW2MN _0x3,0
	CALL _lcd_puts
; 0000 00A0 lcd_gotoxy(0, 1);
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 00A1 lcd_puts("hahahahahahahahahahahahahahahahahahahaha");
	__POINTW2MN _0x3,26
	CALL _lcd_puts
; 0000 00A2 while (1)
_0x4:
...
; 0000 00B0             hour = 0;
	...
	STS  _hour+1,R30
; 0000 00B1       }
; 0000 00B2       lcd_gotoxy(25, 0);
_0x9:
	LDI  R30,LOW(25)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00B3       f = (float) sec / 100;
	LDS  R30,_sec
	LDS  R31,_sec+1
	CALL SUBOPT_0x1
	MOVW R26,R30
	...
	STS  _f+2,R22
	STS  _f+3,R23
; 0000 00B4       sprintf(str, "%d:%d:%d   %4.2f", hour, min_, sec, f);
	LDI  R30,LOW(_str)
	LDI  R31,HIGH(_str)
	ST   -Y,R31
	ST   -Y,R30
