...
; 0000 0091             PORTD.7 = 0;
; 0000 0092 
; 0000 0093             PORTD = 0b00111111;
; 0000 0094             PORTD = 0x3f;
; 0000 0095 */                 // gfedcba
; 0000 0096            PORTD = 0b00111111; // 0
	LDI  R30,LOW(63)
	RCALL SUBOPT_0x0
; 0000 0097            delay_ms(300);
; 0000 0098            PORTD = 0b00000110; // 1
	LDI  R30,LOW(6)
	RCALL SUBOPT_0x0
; 0000 0099            delay_ms(300);
; 0000 009A            PORTD = 0b01011011; // 2
	LDI  R30,LOW(91)
	RCALL SUBOPT_0x0
; 0000 009B            delay_ms(300);
; 0000 009C            PORTD = 0b01001111; // 3
	LDI  R30,LOW(79)
	RCALL SUBOPT_0x0
; 0000 009D            delay_ms(300);
; 0000 009E            PORTD = 0b01100110; // 4
	LDI  R30,LOW(102)
	RCALL SUBOPT_0x0
; 0000 009F            delay_ms(300);
; 0000 00A0            PORTD = 0b01101101; // 5
	LDI  R30,LOW(109)
	RCALL SUBOPT_0x0
; 0000 00A1            delay_ms(300);
; 0000 00A2            PORTD = 0b01111101; // 6
	LDI  R30,LOW(125)
	RCALL SUBOPT_0x0
; 0000 00A3            delay_ms(300);
; 0000 00A4            PORTD = 0b00000111; // 7
	LDI  R30,LOW(7)
	RCALL SUBOPT_0x0
; 0000 00A5            delay_ms(300);
; 0000 00A6            PORTD = 0b01111111; // 8
	LDI  R30,LOW(127)
	RCALL SUBOPT_0x0
; 0000 00A7            delay_ms(300);
; 0000 00A8            PORTD = 0b01101111; // 9
	LDI  R30,LOW(111)
	RCALL SUBOPT_0x0
