...
_0x0:
	...
	.DB  0x0,0x48,0x65,0x6C,0x6C,0x6F,0x20,0x44
	.DB  0x65,0x61,0x72,0x20,0x20,0x20,0x20,0x20
	.DB  0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 008D // RD - PORTB Bit 2
; 0000 008E // EN - PORTB Bit 1
...
; 0000 0099       lcd_clear();
	RCALL _lcd_clear
; 0000 009A       lcd_puts("MHTrXz          ");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
; 0000 009B       lcd_puts("Hello Dear      ");
	__POINTW2MN _0x6,17
	RCALL _lcd_puts
; 0000 009C       delay_ms(10000);
	LDI  R26,LOW(10000)
	LDI  R27,HIGH(10000)
	CALL _delay_ms
; 0000 009D       }
