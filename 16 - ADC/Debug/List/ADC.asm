...
_0x0:
	...
	.DB  0x0,0x54,0x45,0x4D,0x50,0x3A,0x20,0x20
	.DB  0x25,0x33,0x2E,0x32,0x66,0x0
_0x2000000:
...
; 0000 0047           read_temp = read_adc(0)/2.048;
	...
	CALL __DIVF21
	STS  _read_temp,R30
	STS  _read_temp+1,R31
	STS  _read_temp+2,R22
	STS  _read_temp+3,R23
; 0000 0048           sprintf(temp, "TEMP:  %3.2f", read_temp);
	...
	ST   -Y,R30
	LDS  R30,_read_temp
	LDS  R31,_read_temp+1
	LDS  R22,_read_temp+2
	LDS  R23,_read_temp+3
	CALL __PUTPARD1
	LDI  R24,4
	CALL _sprintf
	ADIW R28,8
